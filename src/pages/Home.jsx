            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para mt-[30px]">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque, assumenda. Doloribus illo ad omnis, necessitatibus, quo nihil ex, eum maiores maxime error quam? Aspernatur repellendus ex ad, nihil nobis tenetur?
                </p>
                <button className="btn" onClick={reqhandler}>
