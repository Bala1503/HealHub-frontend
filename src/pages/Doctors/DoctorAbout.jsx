...
const DoctorAbout = ({name,about,qualifications,experiences}) => {
  return (
    <div>
        <div>
            <h3 className="text-[20px] leading-[30px] text-headingColor fond-semibold flex items-center gap-2">
                About of
        ...
        <div className="mt-12">
            <h3 className="text-[20px] leading-[30px] text-headingColor fond-semibold">Education</h3>
        ...
        <div className="mt-12">
            <h3 className="text-[20px] leading-[30px] text-headingColor fond-semibold">Experience</h3>
