...

                {
                    ...
                    <div className="pb-[50px] px-[30px] rounded-md">
                        ...
                        <div className="mt-[50px] md:mt-[100px]">
                            ...
                            <button disabled={loading1 && true} className="w-full bg-red-600 mt-4 p-3 text-[16px] leading-7 rounded-md text-white" onClick={handleDelete}>{loading1 ? <HashLoader size={25} color='#ffffff' /> :'Delete Account'}</button>
                        </div>
                    </div>
