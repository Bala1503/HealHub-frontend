...
const Profile = ({doctorData})=>{
    ...
    return (<div>
        ...
        <form>
            ...
            <div className="mb-5">
                <p className="form__label">
                    Currently Working Hospital/Clinic name with city*
                </p>
                <input type="text" name="address" value={formData.address} onChange={handleInputChange} placeholder="Enter address" className="form__input"/>
            </div>
            <div className="mb-5">
                <p className="form__label">
                    Bio*
            ...
            <div className="mb-5">
                ...
                {formData.experiences?.map((item,index)=> <div key={index}>
                    <div>
                        ...
                        <button className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer" onClick={e=>(deleteExperience(e,index))}>
                            <AiOutlineDelete/>
                        </button>
                    </div>
                </div>)}
